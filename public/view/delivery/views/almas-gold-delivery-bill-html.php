<?php
     ...
     * @package           almas-gold delivery billing preview
     */
        ...
        <div class="billing_results">
                    ...
                    if ($transaction_processed === '1') {
                        echo '
                            ...
                            <span class="billing-icon-title">
                                ...
                                <h4 class="title">' . esc_html__('صورت‌حساب دریافت طلا', 'almas-gold') . '</h4>
                            </span>
                            <label style="font-weight: 700" class="success massage">
                                ' . esc_html__('سفارش دریافت طلا با موفقیت ثبت شد.', 'almas-gold') . '
                            </label>
                        ';
                    } else {
                        if ($transaction_processed !== '1') {
                            echo '
                                ...
                                <label style="font-weight: 700" class="failed massage">
                                    ' . esc_html__('سفارش دریافت طلا ثبت نشد.', 'almas-gold') . '
                                </label>
                            ';
                        }
                    }
            ...
            <div class="biliing-form">
                <ul class="biliing-form-list-ul">
                    ...
                    <li class="biliing-form-list-li">
                        ...
                        <span>
                            <?= jdate('d F - H:i', strtotime($transaction_date . ' +03:30')); ?>
                        </span>
                    </li>
                ...
                <ul class="biliing-form-list-ul">
                    <?php
                        if ($transaction_status === 'approved') {
                            ...
                            if ($transaction_processed !== 'approved') {
                                echo '
                                    <li class="biliing-form-list-li">
            ...
            <div class="biliing-form">
                <ul class="biliing-form-list-ul">
                    ...
                    <li class="biliing-form-list-li">
                        <label><i class="  prk-percentage-square"></i>
                            <?= esc_html__('کارمزد سفارش', 'almas-gold'); ?>
                        </label>
                        <span>
                            <span>
                                <valsOrderPricePayed>
                ...
                <ul class="biliing-form-list-ul">
                            ...
                            if ($delivery_status === 'approved') {
                                echo '
                                    ...
                                    <span style="color: #0D9277;display: flex;align-items: center;gap: 4px;">
                                        <i class=" prk-tick-square" style="font-weight: 600;"></i>' . esc_html__("تایید شد", "almas-gold") . '
                                    </span>
                                ';
                            } else {
                                echo '
                    ...
                    <div class="biliing-form-list-pay" style="margin-top: 30px;z-index: 1;">
                        <li class="biliing-form-buttons">
                            <button class="almas-gold-billing-button biliing-form-button-gold" type="button" onclick="redirectToPageDeliveryBill()">
                                <i class=" prk-book"></i> لیست دریافت‌ها
                            </button>
                            <script>
                                function redirectToPageDeliveryBill() {
