...
if(!function_exists("almas_gold_sale_billing_preview_template")) {
    function almas_gold_sale_billing_preview_template()
    {
        ...
        if($sale_data) {
            ...
            require_once "views/almas-gold-sale-bill-html.php";
        } else {
...
almas_gold_sale_billing_preview_template();
