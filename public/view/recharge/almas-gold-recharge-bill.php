...
if(!function_exists("almas_gold_recharge_billing_preview_template")) {
    function almas_gold_recharge_billing_preview_template()
    {
        ...
        if($recharge_data) {
            ...
            require_once "views/almas-gold-recharge-bill-html.php";
        } else {
...
almas_gold_recharge_billing_preview_template();
