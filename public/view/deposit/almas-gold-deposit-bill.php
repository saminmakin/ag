...
if(!function_exists("almas_gold_deposit_billing_preview_template")) {
    function almas_gold_deposit_billing_preview_template()
    {
        ...
        if($deposit_data) {
            ...
            require_once "views/almas-gold-deposit-bill-html.php";
        } else {
...
almas_gold_deposit_billing_preview_template();
