<?php
    ...
    ?>
        <div>
            <?php almas_gold_show_recharge_details(); ?>
        </div>
        <div class="wrap" id="almas_gold_admin_container_box" style="padding: 25px 7px 0 10px">
            <div class="list_head">
                <div>
                    <h4>
                        <?php esc_html_e('لیست شارژ کیف پول', 'almas-gold'); ?>
                    </h4>
                </div>
                <div>
                        ...
                        <div style="margin-left: 37px; color: #195a21;">
                            <?php
                                if (isset($_POST['delete_all_orders_submit'])) {
                                    ...
                                    $wpdb->query($wpdb->prepare("DELETE FROM $table_name_recharge WHERE transaction_processed != '1'"));
                                    ?>
                                        <script>
                                    ...
                                    <td>
                                        <?php 
                                            if ($transaction_status !== 'approved') {
                                                ...
                                                echo '
                                                    <a class="show_detailes" href="'. admin_url('admin.php?page=almas-gold-recharge&recharge_id=' . esc_attr($recharge_id)).'">
