...
if(isset($_POST["CGT_receive_submit"]) && check_admin_referer("CGT_receive_submit_nonce", "CGT_receive_submit_nonce_field")) {
    ...
    if(isset($_POST["CGT_deposit_from_customer_wallet"]) && $_POST["CGT_deposit_from_customer_wallet"] === "1" && $update_delivery_data !== false) {
        ...
        $new_wallet_balance = $customer_wallet_balance - $delivery_final_price;
        ...
        if($update_wallet !== false) {
            ...
            echo "\r\n                        <p style=\"color: green; font-weight: bold\">\r\n                            موفق! کیف پول کاربر کم شد\r\n                        </p>\r\n                    ";
        } else {
            echo "\r\n                        <p style=\"color: red; font-weight: bold\">\r\n                            خطا! به‌روزرسانی کیف پول کاربر ناموفق بود \r\n                        </p>\r\n                    ";
        }
    }
    if(isset($_POST["CGT_deposit_from_customer_safe"]) && $_POST["CGT_deposit_from_customer_safe"] === "1" && $update_delivery_data !== false) {
