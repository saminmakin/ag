...
if(isset($_POST["normal_receive_submit"]) && check_admin_referer("normal_receive_submit_nonce", "normal_receive_submit_nonce_field")) {
    ...
    if(isset($_POST["deposit_from_customer_wallet"]) && $_POST["deposit_from_customer_wallet"] === "1" && $update_delivery_data !== false) {
    ...
    if(isset($_POST["deposit_from_customer_safe"]) && $_POST["deposit_from_customer_safe"] === "1" && $update_delivery_data !== false) {
